...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "w-full px-4 py-3 rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
